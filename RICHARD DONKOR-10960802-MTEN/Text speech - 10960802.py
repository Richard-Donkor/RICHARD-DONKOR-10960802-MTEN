...
layout = [[sg.Text('Select the type of voice:', text_color='black', background_color='green'),
           ...
           sg.Radio('Female', 'RADIO1', key='female', background_color='blue')],
          [sg.Text('Enter text to speak:', text_color='white', background_color='orange')],
          [sg.InputText(key='input'), sg.Button('speak', button_color='red')],
          ]

window = sg.Window('TEXT TO SPEECH', layout, background_color='violet')
